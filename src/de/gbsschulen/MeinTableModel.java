...
public class MeinTableModel extends AbstractTableModel {
    ...
    public MeinTableModel(List<Gegenstand> gegenstaende) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                return gegenstand.getPreis();
            case 3:
                return gegenstand.getAnzahl() * gegenstand.getPreis();
        }
        return null;
    }
    ...
    public void speichern(File file) throws IOException {
        ...
        for (Gegenstand gegenstand : gegenstaende) {
            bw.write(gegenstand.getBezeichnung() + "," + gegenstand.getAnzahl() + "," + gegenstand.getPreis() + "," + gegenstand.getAnzahl()* gegenstand.getPreis());
            bw.newLine();
        }
        if (bw != null) {
            bw.close();
    ...
    public double getGesamtPreis() {
        ...
        for (Gegenstand gegenstand : gegenstaende) {
        gesamtpreis += gegenstand.getAnzahl() * gegenstand.getPreis();
        }
        return gesamtpreis;
        }
